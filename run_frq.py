...
def main(argv):
    ...
    work_folder = f'spread={FLAGS.spread}_obj={FLAGS.obj_func}_threshold={FLAGS.threshold}_critic={FLAGS.critic}_v={FLAGS.vov}_liabttms={FLAGS.liab_ttms}_hedfrq={FLAGS.hed_frq}'
